...
def _enrich_pe(conn, stock_count):
    ...
    PE_FALLBACK = {
        "688256": -1,    "688041": 120.5, "002371": 55.0,  "688012": 80.0,
        "603986": 45.0,  "600584": 35.0,  "002594": 32.1,  "300750": 25.8,
        "601689": 35.6,  "002050": 42.1,  "600519": 32.8,  "000858": 22.5,
        "600276": 55.0,  "000333": 16.5,  "601318": 9.5,   "600036": 7.2,
        "600941": 14.1,  "601088": 10.2,  "600900": 20.5,  "601985": 18.0,
        "003816": 16.0,  "600406": 28.3,  "000400": 22.8,  "002837": 38.5,
    }
...
def collect_portfolio(conn):
    ...
    """, (round(total, 2), round(profit, 2),
          round(profit / total_contributed * 100, 2) if total_contributed > 0 else 0,
          round(cash, 2),
          round(cat_mv.get("核心仓", 0) / total * 100, 1) if total > 0 else 0,
          round(cat_mv.get("机动仓", 0) / total * 100, 1) if total > 0 else 0,
          0))
    conn.commit()
    print(f"💰 持仓快照 ✓")
